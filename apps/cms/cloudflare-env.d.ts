/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c0856b024a731747db171d60e3f16aaa)
// Runtime types generated with workerd@1.20260305.0 2025-08-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		R2: R2Bucket;
		D1: D1Database;
		WEB: Fetcher /* raveo-web-preview */ | Fetcher /* raveo-web */;
		ASSETS?: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "WEB_URL" | "REVALIDATE_SECRET">> {}
}
